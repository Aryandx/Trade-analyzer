...
start "Morning Scanner" cmd /k "python morning_scanner.py & echo. & echo Done. Run --live at 9:30 AM: python morning_scanner.py --live & pause"
...
start "Auto Push Daemon" cmd /k "python auto_push.py"
